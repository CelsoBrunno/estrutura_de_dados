...
def circulo_no(d, x, y, v, fill=AZUL, r=38):
    d.ellipse((x - r, y - r, x + r, y + r), fill=fill, outline=NAVY, width=3)
...
def bst():
    ...
    r = circulo_no(d, 700, 130, 50, (255, 236, 210))
    e = circulo_no(d, 420, 280, 30)
    dir_ = circulo_no(d, 980, 280, 70)
    circulo_no(d, 280, 430, 20)
    circulo_no(d, 560, 430, 40)
...
def bst_no():
    im, d = nova(1400, 480)
    centro_txt(d, (700, 36), "O no da BST: valor + dois ponteiros (nao e uma lista)", FT, NAVY)
    caixa(d, (430, 90, 970, 280), (255, 236, 210), LARANJA, 18)
    centro_txt(d, (700, 120), "NoArvore", FB, LARANJA)
    centro_txt(d, (700, 168), "valor = 50", FT, NAVY)
    centro_txt(d, (560, 230), "esquerda", FS, TEAL)
    centro_txt(d, (840, 230), "direita", FS, TEAL)
    circulo_no(d, 280, 380, 30)
    circulo_no(d, 1120, 380, 70)
    seta(d, (520, 250), (330, 350), TEAL)
    seta(d, (880, 250), (1070, 350), TEAL)
    centro_txt(d, (280, 450), "subarvore menor", FS, TEAL)
    centro_txt(d, (1120, 450), "subarvore maior", FS, TEAL)
    salvar(im, "05_bst_no.png")


def bst_35():
    im, d = nova(1400, 640)
    centro_txt(d, (700, 36), "Entra o 35: caminha 50 -> 30 -> 40 e pendura a esquerda do 40", FT, NAVY)
    r = circulo_no(d, 700, 120, 50, (255, 236, 210))
    n30 = circulo_no(d, 420, 260, 30)
    n70 = circulo_no(d, 980, 260, 70)
    circulo_no(d, 260, 400, 20)
    n40 = circulo_no(d, 560, 400, 40)
    n35 = circulo_no(d, 480, 540, 35, (255, 214, 150))
    seta(d, (r[0] - 30, r[1] + 36), (n30[0] + 20, n30[1] - 40), LARANJA, 4)
    seta(d, (r[0] + 30, r[1] + 36), (n70[0] - 20, n70[1] - 40), TEAL)
    seta(d, (n30[0] - 24, n30[1] + 36), (260, 360), TEAL)
    seta(d, (n30[0] + 24, n30[1] + 36), (n40[0] - 10, n40[1] - 40), LARANJA, 4)
    seta(d, (n40[0] - 16, n40[1] + 36), (n35[0] + 8, n35[1] - 40), LARANJA, 4)
    centro_txt(d, (560, 190), "35 < 50", FS, LARANJA)
    centro_txt(d, (520, 320), "35 > 30", FS, LARANJA)
    centro_txt(d, (420, 470), "35 < 40", FS, LARANJA)
    centro_txt(d, (700, 610), "em-ordem agora: 20  30  35  40  50  70   (ainda crescente)", F, PRETO)
    salvar(im, "05_bst_35.png")


def bst_pende():
    im, d = nova(1400, 680)
    centro_txt(d, (700, 32), "A BST continua correta, mas vira lista  ->  busca O(n)", FT, NAVY)
    centro_txt(d, (360, 80), "Depois de 35, 36, 37", FB, VERMELHO)
    r = circulo_no(d, 360, 140, 50, (255, 236, 210), 32)
    n30 = circulo_no(d, 220, 240, 30, AZUL, 32)
    circulo_no(d, 500, 240, 70, AZUL, 32)
    circulo_no(d, 140, 340, 20, AZUL, 32)
    n40 = circulo_no(d, 300, 340, 40, AZUL, 32)
    n35 = circulo_no(d, 250, 440, 35, ROSA, 32)
    n36 = circulo_no(d, 320, 530, 36, ROSA, 32)
    n37 = circulo_no(d, 390, 620, 37, ROSA, 32)
    seta(d, (r[0] - 18, r[1] + 28), (n30[0] + 12, n30[1] - 28), TEAL)
    seta(d, (r[0] + 18, r[1] + 28), (488, 214), TEAL)
    seta(d, (n30[0] - 16, n30[1] + 28), (150, 312), TEAL)
    seta(d, (n30[0] + 16, n30[1] + 28), (n40[0] - 8, n40[1] - 28), TEAL)
    seta(d, (n40[0] - 10, n40[1] + 28), (n35[0] + 6, n35[1] - 28), VERMELHO)
    seta(d, (n35[0] + 10, n35[1] + 28), (n36[0] - 6, n36[1] - 28), VERMELHO)
    seta(d, (n36[0] + 10, n36[1] + 28), (n37[0] - 6, n37[1] - 28), VERMELHO)

    centro_txt(d, (1040, 80), "Pior caso: inserir 1, 2, 3, 4, 5", FB, VERMELHO)
    ys = [140, 240, 340, 440, 540]
    for i, (v, y) in enumerate(zip((1, 2, 3, 4, 5), ys)):
        circulo_no(d, 1040, y, v, ROSA if i else (255, 236, 210), 32)
        if i:
            seta(d, (1040, ys[i - 1] + 32), (1040, y - 32), VERMELHO)
    centro_txt(d, (700, 655), "Regra esquerda/direita ok. Formato ruim: nao descarta metade.", F, PRETO)
    salvar(im, "05_bst_pende.png")


def bst_rotacao():
    im, d = nova(1400, 620)
    centro_txt(d, (700, 32), "Rotacao a esquerda: o filho sobe, o pai desce  (10, 20, 30)", FT, NAVY)
    caixa(d, (40, 80, 620, 560), (252, 246, 240), LARANJA, 12)
    centro_txt(d, (330, 112), "ANTES  (pendente)", FB, VERMELHO)
    circulo_no(d, 330, 190, 10, (255, 236, 210))
    circulo_no(d, 330, 340, 20, ROSA)
    circulo_no(d, 330, 490, 30, ROSA)
    seta(d, (330, 228), (330, 302), VERMELHO, 4)
    seta(d, (330, 378), (330, 452), VERMELHO, 4)
    centro_txt(d, (470, 340), "sempre a direita", FS, VERMELHO)

    centro_txt(d, (700, 320), "gira", FB, LARANJA)
    seta(d, (640, 320), (760, 320), LARANJA, 5)

    caixa(d, (780, 80, 1360, 560), MINT, TEAL, 12)
    centro_txt(d, (1070, 112), "DEPOIS  (equilibrada)", FB, TEAL)
    circulo_no(d, 1070, 230, 20, MINT)
    circulo_no(d, 900, 430, 10, AZUL)
    circulo_no(d, 1240, 430, 30, AZUL)
    seta(d, (1040, 262), (930, 396), TEAL, 4)
    seta(d, (1100, 262), (1210, 396), TEAL, 4)
    centro_txt(d, (1070, 530), "10 < 20 < 30 continua valendo", FS, NAVY)
    salvar(im, "05_bst_rotacao.png")


def bst_rotacao_filhos():
    """Gira o 30, que ja tem filhos (20 e 40). O 35 muda de pai: era esquerdo do 40, vira direito do 30."""
    im, d = nova(1400, 700)
    centro_txt(d, (700, 28), "Rotacao com filhos: o 35 nao some — muda de pai", FT, NAVY)
    caixa(d, (30, 64, 680, 670), (252, 246, 240), LARANJA, 12)
    centro_txt(d, (355, 92), "ANTES  (gira o 30)", FB, VERMELHO)
    r = 28
    a50 = circulo_no(d, 360, 150, 50, (255, 236, 210), r)
    a30 = circulo_no(d, 230, 260, 30, (255, 214, 150), r)
    a70 = circulo_no(d, 520, 260, 70, AZUL, r)
    a20 = circulo_no(d, 130, 380, 20, AZUL, r)
    a40 = circulo_no(d, 330, 380, 40, (255, 214, 150), r)
    a35 = circulo_no(d, 280, 500, 35, ROSA, r)
    a36 = circulo_no(d, 340, 590, 36, ROSA, r)
    a37 = circulo_no(d, 400, 660, 37, ROSA, 24)
    seta(d, (a50[0] - 16, a50[1] + 24), (a30[0] + 10, a30[1] - 24), LARANJA, 3)
    seta(d, (a50[0] + 16, a50[1] + 24), (a70[0] - 10, a70[1] - 24), TEAL, 3)
    seta(d, (a30[0] - 14, a30[1] + 24), (a20[0] + 8, a20[1] - 24), TEAL, 3)
    seta(d, (a30[0] + 14, a30[1] + 24), (a40[0] - 8, a40[1] - 24), LARANJA, 3)
    seta(d, (a40[0] - 8, a40[1] + 24), (a35[0] + 6, a35[1] - 24), VERMELHO, 3)
    seta(d, (a35[0] + 8, a35[1] + 24), (a36[0] - 4, a36[1] - 24), VERMELHO, 3)
    seta(d, (a36[0] + 8, a36[1] + 20), (a37[0] - 4, a37[1] - 20), VERMELHO, 3)
    centro_txt(d, (500, 500), "40 ja tem filho (35)", FS, VERMELHO)

    caixa(d, (720, 64, 1370, 670), MINT, TEAL, 12)
    centro_txt(d, (1045, 92), "DEPOIS  (30 desceu, 40 subiu)", FB, TEAL)
    b50 = circulo_no(d, 1060, 150, 50, (255, 236, 210), r)
    b40 = circulo_no(d, 920, 260, 40, MINT, r)
    b70 = circulo_no(d, 1220, 260, 70, AZUL, r)
    b30 = circulo_no(d, 820, 390, 30, MINT, r)
    b20 = circulo_no(d, 730, 520, 20, AZUL, r)
    b35 = circulo_no(d, 910, 520, 35, ROSA, r)
    b36 = circulo_no(d, 970, 610, 36, ROSA, 24)
    b37 = circulo_no(d, 1030, 668, 37, ROSA, 22)
    seta(d, (b50[0] - 16, b50[1] + 24), (b40[0] + 10, b40[1] - 24), TEAL, 3)
    seta(d, (b50[0] + 16, b50[1] + 24), (b70[0] - 10, b70[1] - 24), TEAL, 3)
    seta(d, (b40[0] - 12, b40[1] + 24), (b30[0] + 8, b30[1] - 24), TEAL, 3)
    seta(d, (b30[0] - 14, b30[1] + 24), (b20[0] + 8, b20[1] - 24), TEAL, 3)
    seta(d, (b30[0] + 14, b30[1] + 24), (b35[0] - 6, b35[1] - 24), LARANJA, 3)
    seta(d, (b35[0] + 8, b35[1] + 20), (b36[0] - 4, b36[1] - 18), VERMELHO, 3)
    seta(d, (b36[0] + 8, b36[1] + 18), (b37[0] - 4, b37[1] - 16), VERMELHO, 3)
    centro_txt(d, (1180, 520), "30 ficou pai de 20 e 35", FS, TEAL)
    salvar(im, "05_bst_rotacao_filhos.png")


def bst_meio_32():
    """Reconstroi pelo meio (20..70) e depois insere o 32."""
    im, d = nova(1400, 680)
    centro_txt(d, (700, 26), "Reset pelo meio, depois entra o 32", FT, NAVY)
    r = 26
    caixa(d, (20, 56, 460, 650), (252, 246, 240), LARANJA, 10)
    centro_txt(d, (240, 82), "1. Pendente", FB, VERMELHO)
    p50 = circulo_no(d, 250, 130, 50, (255, 236, 210), r)
    p30 = circulo_no(d, 150, 210, 30, AZUL, r)
    p70 = circulo_no(d, 350, 210, 70, AZUL, r)
    p20 = circulo_no(d, 80, 300, 20, AZUL, r)
    p40 = circulo_no(d, 220, 300, 40, AZUL, r)
    p35 = circulo_no(d, 180, 400, 35, ROSA, r)
    p36 = circulo_no(d, 230, 490, 36, ROSA, r)
    p37 = circulo_no(d, 280, 580, 37, ROSA, r)
    seta(d, (p50[0] - 12, p50[1] + 22), (p30[0] + 8, p30[1] - 22), TEAL, 2)
    seta(d, (p50[0] + 12, p50[1] + 22), (p70[0] - 8, p70[1] - 22), TEAL, 2)
    seta(d, (p30[0] - 12, p30[1] + 22), (p20[0] + 6, p20[1] - 22), TEAL, 2)
    seta(d, (p30[0] + 12, p30[1] + 22), (p40[0] - 6, p40[1] - 22), TEAL, 2)
    seta(d, (p40[0] - 8, p40[1] + 22), (p35[0] + 4, p35[1] - 22), VERMELHO, 2)
    seta(d, (p35[0] + 8, p35[1] + 22), (p36[0] - 4, p36[1] - 22), VERMELHO, 2)
    seta(d, (p36[0] + 8, p36[1] + 22), (p37[0] - 4, p37[1] - 22), VERMELHO, 2)

    caixa(d, (480, 56, 920, 650), MINT, TEAL, 10)
    centro_txt(d, (700, 82), "2. Meio = 37", FB, TEAL)
    m37 = circulo_no(d, 700, 140, 37, MINT, r)
    m35 = circulo_no(d, 580, 250, 35, AZUL, r)
    m50 = circulo_no(d, 820, 250, 50, AZUL, r)
    m30 = circulo_no(d, 520, 360, 30, AZUL, r)
    m36 = circulo_no(d, 640, 360, 36, AZUL, r)
    m40 = circulo_no(d, 760, 360, 40, AZUL, r)
    m70 = circulo_no(d, 880, 360, 70, AZUL, r)
    m20 = circulo_no(d, 520, 480, 20, AZUL, r)
    seta(d, (m37[0] - 12, m37[1] + 22), (m35[0] + 8, m35[1] - 22), TEAL, 2)
    seta(d, (m37[0] + 12, m37[1] + 22), (m50[0] - 8, m50[1] - 22), TEAL, 2)
    seta(d, (m35[0] - 10, m35[1] + 22), (m30[0] + 6, m30[1] - 22), TEAL, 2)
    seta(d, (m35[0] + 10, m35[1] + 22), (m36[0] - 6, m36[1] - 22), TEAL, 2)
    seta(d, (m50[0] - 10, m50[1] + 22), (m40[0] + 6, m40[1] - 22), TEAL, 2)
    seta(d, (m50[0] + 10, m50[1] + 22), (m70[0] - 6, m70[1] - 22), TEAL, 2)
    seta(d, (m30[0], m30[1] + 24), (m20[0], m20[1] - 24), TEAL, 2)
    centro_txt(d, (700, 560), "em-ordem: 20 30 35 36 37 40 50 70", FS, NAVY)
    centro_txt(d, (700, 600), "30 e pai so do 20", FS, CINZA)

    caixa(d, (940, 56, 1380, 650), AZUL, TEAL, 10)
    centro_txt(d, (1160, 82), "3. Entra o 32", FB, NAVY)
    n37 = circulo_no(d, 1160, 140, 37, MINT, r)
    n35 = circulo_no(d, 1040, 250, 35, AZUL, r)
    n50 = circulo_no(d, 1280, 250, 50, AZUL, r)
    n30 = circulo_no(d, 980, 360, 30, (255, 214, 150), r)
    n36 = circulo_no(d, 1100, 360, 36, AZUL, r)
    n40 = circulo_no(d, 1220, 360, 40, AZUL, r)
    n70 = circulo_no(d, 1340, 360, 70, AZUL, r)
    n20 = circulo_no(d, 920, 490, 20, AZUL, r)
    n32 = circulo_no(d, 1040, 490, 32, (255, 214, 150), r)
    seta(d, (n37[0] - 12, n37[1] + 22), (n35[0] + 8, n35[1] - 22), TEAL, 2)
    seta(d, (n37[0] + 12, n37[1] + 22), (n50[0] - 8, n50[1] - 22), TEAL, 2)
    seta(d, (n35[0] - 10, n35[1] + 22), (n30[0] + 6, n30[1] - 22), TEAL, 2)
    seta(d, (n35[0] + 10, n35[1] + 22), (n36[0] - 6, n36[1] - 22), TEAL, 2)
    seta(d, (n50[0] - 10, n50[1] + 22), (n40[0] + 6, n40[1] - 22), TEAL, 2)
    seta(d, (n50[0] + 10, n50[1] + 22), (n70[0] - 6, n70[1] - 22), TEAL, 2)
    seta(d, (n30[0] - 10, n30[1] + 22), (n20[0] + 6, n20[1] - 22), TEAL, 2)
    seta(d, (n30[0] + 10, n30[1] + 22), (n32[0] - 6, n32[1] - 22), LARANJA, 3)
    centro_txt(d, (1160, 560), "32 < 37, > 30, < 35", FS, LARANJA)
    centro_txt(d, (1160, 600), "30 agora tem 20 e 32", FS, NAVY)
    salvar(im, "05_bst_meio_32.png")
